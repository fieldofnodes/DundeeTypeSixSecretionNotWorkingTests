...
public:
    ...
    void TestDistanceBetweenTwoCapsules2d()
    {
    ...
    void TestDistanceBetweenTwoCapsules3d()
    {
    ...
    void TestCalculateForceDirectionAndContactPoints()
    {
        CapsuleForce<2, 2> force;
    ...
    void TestCalculateForceMagnitude()
    {
        CapsuleForce<2, 2> force;
