...
public:
	...
	void xTestSmallSymmetric3dCapsuleSimulation()
	{
		EXIT_IF_PARALLEL;
	...
	void TestSmallSymmetric3dCapsuleSimulationWithMachineProperties()
	{
		EXIT_IF_PARALLEL;
		// Create some capsules
		std::vector<Node<3>*> nodes;
	...
	void TestMachineGlobalCoordinates()
		{
			EXIT_IF_PARALLEL;
			// Create some capsules
			std::vector<Node<3>*> nodes;
	...
	void TestSmallSymmetric3dCapsuleSimulationWithMachinePropertiesAndDivision()
	{
		EXIT_IF_PARALLEL;
		// Create some capsules
		std::vector<Node<3>*> nodes;
	...
	void TestSmallSymmetric3dCapsuleSimulationWithMachinePropertiesAndDivisionAndModifier()
	{
		EXIT_IF_PARALLEL;
		// Create some capsules
		std::vector<Node<3>*> nodes;
